...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sample_component = __webpack_require__(205);

	var _sample_component2 = _interopRequireDefault(_sample_component);
	...
	function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } // thunk middleware for aync actions in redux(doing things redux way)
		...
		_createClass(App, [{
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					{ className: 'app' },
					_react2.default.createElement(_sample_component2.default, null)
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var sampleReducer = function sampleReducer() {
		...
		switch (action.type) {
			case _actions.SAMPLE_ACTION:
				return _extends({}, state, { msg: action.payload }); // ES6 way to clone obj
		};
		return state;
	};
...
/***/ function(module, exports) {
	...
	var SAMPLE_ACTION = exports.SAMPLE_ACTION = 'SAMPLE_ACTION';

	var sampleAction = exports.sampleAction = function sampleAction(data) {
		return {
			type: SAMPLE_ACTION,
			payload: data
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SampleComponent = function (_React$Component) {
		...
		function SampleComponent(props) {
			...
			_this.props.sampleAction('Hi This is React Redux Boilerplate');
			return _this;
		}
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps, { sampleAction: _actions.sampleAction })(SampleComponent);
